...
const CreateProblem = () => {
    ...
    async function handleSubmit(event: FormEvent) {
        ...
        const { name, truck, whatsapp, description} = formData
        const uf = selectedUf
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        <div className="field">
                            ...
                            <input type="text" name="truck"id="truck"onChange={handleInputChange}/>
                        </div>
                        <div className="field">
                ...
                <fieldset>
                    ...
                    <Map center={initialPosition} zoom={18}>
                        ...
                        />
                        <Marker position={initialPosition} zoom={17.5}/>
                    </Map>
                    <div className="field-group">
                        <div className="field">
                            <label htmlFor="uf">
                ...
                <fieldset>
                    ...
                    > 
                            <div className="container">
                                ...
                                <input placeholder="Exemplo: Freios" type="text" name="description"id="description"onChange={handleInputChange}/>
                            </div>
                            <img src={Xicon} alt="Xicon" onClick={() => handleCloseModal()}/>
